...
6. Write Status/Evidence/Applicability back into the checklist row — only after the relevant checkpoint(s) below have actually passed. Documentation-type rows (v5.0.0-2.1.1, v5.0.0-6.1.1, v5.0.0-8.1.1, v5.0.0-15.1.1) get `here-security-decisions.md`'s matching section drafted/current first.
