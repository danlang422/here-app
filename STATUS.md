...
5. **Activity table enhancements** — Properties/icons column (compact behavior flag indicators), richer filtering (staff-based, block-based, enrollment-derived). Low priority until more real data exists.
...
| `docs/user-flows/` | Per-feature UX narratives and build specs — admin dashboard, enrollment design, schedule action map, **enrollment panel build spec** |
